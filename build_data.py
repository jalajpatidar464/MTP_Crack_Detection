...
folder['initial'] = '/home/jalaj/Downloads/'
# The path where the repository is stored
folder['main'] = folder['initial'] + 'crack_detection_CNN_masonry-main/'
...
trainPaths = os.listdir("./dataset/crack_detection_224_images/")
trainLabels = os.listdir("./dataset/crack_detection_224_masks/")

for i in range(len(trainPaths)):
    trainPaths[i] = "./dataset/crack_detection_224_images/" + trainPaths[i]

for i in range(len(trainLabels)):
    trainLabels[i] = "./dataset/crack_detection_224_images/" + trainLabels[i]
...
for (dType, images_path, masks_path, outputPath) in datasets:
    ...
    # create HDF5 writer
    outputPath = outputPath.replace("~/Downloads/crack_detection_CNN_masonry-main", ".")
