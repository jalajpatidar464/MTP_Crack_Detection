...
class Config:
    ...
    def set_repository(self):
        ...
        if self.mode == 'train':
            ...
            #changed  here
            # self.args['counter'] = 6
            # self.args['counter'] = 29081
            self.args['counter'] = 7896
            ...
            # self.args['pretrained_filename'] = 'crack_detection_29081_epoch_1_F1_score_dil_0.000.h5'
            self.args['pretrained_filename'] = 'crack_detection_7896_epoch_10_F1_score_dil_0.693.h5'
