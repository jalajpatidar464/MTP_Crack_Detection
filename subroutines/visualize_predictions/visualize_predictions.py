...
#         # f, arrr = plt.subplots(1,3)
#         # arrr[0,0] = plt.imshow(im)
#         # arrr[0,1] = plt.imshow(gt, vmin=0, vmax=1, cmap='gray')
#         # arrr[0,2] = plt.imshow(prediction, vmin=0, vmax=1, cmap='gray')
# #try_end
...
#         ax2.imshow(gt, vmin=0, vmax=1, cmap='gray')
        ...
        axarr[0].imshow(im)
        axarr[1].imshow(gt, vmin=0, vmax=1, cmap='gray')
        axarr[2].imshow(prediction, vmin=0, vmax=1, cmap='gray')
